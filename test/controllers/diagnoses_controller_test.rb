...
class DiagnosesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnosis" do
    assert_difference('Diagnosis.count') do
      post diagnoses_url, params: { diagnosis: { comment: @diagnosis.comment, evolution: @diagnosis.evolution, inheritance: @diagnosis.inheritance, name: @diagnosis.name, short_name: @diagnosis.short_name, summary: @diagnosis.summary } }
    end
  ...
  test "should update diagnosis" do
    patch diagnosis_url(@diagnosis), params: { diagnosis: { comment: @diagnosis.comment, evolution: @diagnosis.evolution, inheritance: @diagnosis.inheritance, name: @diagnosis.name, short_name: @diagnosis.short_name, summary: @diagnosis.summary } }
